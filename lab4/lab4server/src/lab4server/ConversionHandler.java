	...
	public void run() {
		if (success)
			...
			try {
				...
				if ((!typeOrigin.equalsIgnoreCase("png") && !typeOrigin.equalsIgnoreCase("jpg")
						&& !typeOrigin.equalsIgnoreCase("gif"))
						|| (!typeTarget.equalsIgnoreCase("png") && !typeTarget.toString().equalsIgnoreCase("jpg")
								&& !typeTarget.equalsIgnoreCase("gif"))) {
					success = false;
		...
		// case 2: error
			...
			try {
				...
				BufferedInputStream bisMessageToSend = new BufferedInputStream(
