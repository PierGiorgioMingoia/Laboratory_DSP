...
module.exports.updateTaskActiveStatus = function updateTaskActiveStatus(req, res, next) {
    Tasks.updateTaskActiveStatus(req.query.assignee, req.params.taskId, req.params.active)
        .then(function (response) {
            if (response == "Not_Found") {
                utils.writeJson(res, { errors: [{ 'param': 'Server', 'msg': response }], }, 404);
            } else {
